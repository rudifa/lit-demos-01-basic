// https://github.com/open-wc/lit-demos/blob/master/01-basic/04-properties-and-attributes.js
...
class PropertiesAndAttributes extends LitElement {
  ...
  render() {
    return html`
      ...
      Learn more about web components at <a href=${this.href}>${this.label}</a>
